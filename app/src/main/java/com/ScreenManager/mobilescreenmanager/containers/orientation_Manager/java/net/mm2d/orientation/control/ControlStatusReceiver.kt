...
package com.ScreenManager.mobilescreenmanager.containers.orientation_Manager.java.net.mm2d.orientation.control
...
class ControlStatusReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        val orientation =
            Orientation.of(intent.getIntExtra(EXTRA_ORIENTATION, Orientation.INVALID.value))
